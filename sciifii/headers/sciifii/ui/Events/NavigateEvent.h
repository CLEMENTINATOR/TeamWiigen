#ifndef _NAVIGATE_EVENT_H_
#define _NAVIGATE_EVENT_H_

#include <FastDelegate.h>
#include <list>
#include "NavigateEventArgs.h"

class NavigateEvent : public Libwiisys::Object
{
  public:

    /** Little typedef for a more readable code*/
    typedef fastdelegate::FastDelegate2<Object*,NavigateEventArgs*> DelegateType;
     ...
     */
    virtual void operator()(Object* sender, NavigateEventArgs* args);
