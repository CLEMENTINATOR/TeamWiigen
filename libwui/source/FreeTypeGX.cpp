...
{
  if(this->ftKerningEnabled)
    FT_Set_Pixel_Sizes(this->ftFace, 0, pixelSize);
}
...
void FreeTypeGX::unloadFont()
{
  ...
  for( std::map<wchar_t, ftgxCharData>::iterator i = this->
       fontData.begin();
       i != this->fontData.end();
       i++)
  {
...
uint16_t FreeTypeGX::drawText(int16_t x, int16_t y, const std::string &text, GXColor color, uint16_t textStyling)
{
