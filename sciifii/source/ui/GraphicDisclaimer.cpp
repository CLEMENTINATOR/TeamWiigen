...
GraphicDisclaimer::GraphicDisclaimer() : textDisclaimer(" ", 12, (GXColor)
{
  255,255,255,255
})
{
...
void GraphicDisclaimer::InitializeComponents()
{
  ...
  btnExit.DefaultImage("sd:/sciifii/default/exitbutton_over.png");
  ...
  textDisclaimer.HorizontalAlignement(HAlign_Center);
  textDisclaimer.VerticalAlignement(VAlign_Middle);
