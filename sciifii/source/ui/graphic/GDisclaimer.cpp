...
void GDisclaimer::InitializeComponents()
{
	...
	textDisclaimer.UpDefaultImage("arrow_up.png");
	textDisclaimer.UpOverImage("arrow_up_over.png");
	textDisclaimer.UpClickedImage("arrow_up.png");
	textDisclaimer.DownDefaultImage("arrow_down.png");
	textDisclaimer.DownOverImage("arrow_down_over.png");
	textDisclaimer.DownClickedImage("arrow_down.png");
	textDisclaimer.ScrollBarImage("scrollbar.png");
	textDisclaimer.ScrollBallImage("scrollball.png");
